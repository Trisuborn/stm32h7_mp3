...
#if  ( EXAMPLE == 1 )
    /* Example for 1) */
    static SECTION("CCRAM") lv_disp_buf_t disp_buf_1;
    static SECTION("CCRAM") lv_color_t buf1_1[LV_HOR_RES_MAX * LV_VER_RES_MAX / 5];                      /*A buffer for 10 rows*/
    lv_disp_buf_init(&disp_buf_1, buf1_1, NULL, (LV_HOR_RES_MAX * LV_VER_RES_MAX / 5));   /*Initialize the display buffer*/
#endif

#if  ( EXAMPLE == 2 )
    /* Example for 2) */
    static lv_disp_buf_t disp_buf_2;
    static SECTION("CCRAM") lv_color_t buf2_1[LV_HOR_RES_MAX * LV_VER_RES_MAX / 10];                        /*A buffer for 10 rows*/
    static SECTION("CCRAM") lv_color_t buf2_2[LV_HOR_RES_MAX * LV_VER_RES_MAX / 10];                        /*An other buffer for 10 rows*/
    lv_disp_buf_init(&disp_buf_2, buf2_1, buf2_2, (LV_HOR_RES_MAX * LV_VER_RES_MAX / 10));   /*Initialize the display buffer*/
